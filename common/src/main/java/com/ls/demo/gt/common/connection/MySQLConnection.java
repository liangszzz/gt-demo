package com.ls.demo.gt.common.connection;
...
import com.ls.demo.gt.common.transaction.TransactionNodeCacheListener;
...
public class MySQLConnection implements Connection {
  ...
  public MySQLConnection(Connection connection, CuratorFramework curatorFramework) {
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    return new LogPreparedStatement(connection.prepareStatement(sql));
  }
  ...
  public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
    return new LogPreparedStatement(connection.prepareStatement(sql, autoGeneratedKeys));
  }

  @Override
  public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
    return new LogPreparedStatement(connection.prepareStatement(sql, columnIndexes));
  }

  @Override
  public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
    return new LogPreparedStatement(connection.prepareStatement(sql, columnNames));
  }
